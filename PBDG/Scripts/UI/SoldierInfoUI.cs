...
public class SoldierInfoUI : IUserInterface
{
    ...
    public SoldierInfoUI(BattleGame battleGame) : base(battleGame)
    {
        Initialize();
    }
    ...
    public override void Initialize()
    {
        ...
        // 注册游戏事件
        m_battleGame.RegisterGameEvent(ENUM_GameEvent.SoldierKilled, new SoldierKilledObserverUI(this));
        m_battleGame.RegisterGameEvent(ENUM_GameEvent.SoldierUpgate, new SoldierUpgateObserverUI(this));
